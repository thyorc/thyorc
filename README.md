## 💜 Olá, meu nome é <strong>Thiago F Moura!</strong>

> Sou um desenvolvedor full-stack JR, tive poucas experiências na area como profissional (não exercendo a função). Possuo sólidos conhecimentos em programação funcional, OOP, DevOps, Java, Go, PL/SQL, SQL, NodeJS, Typescript, Javascript e VueJS. Tenho interesse em escalabilidade de aplicações, infraestrutura, melhores práticas de desenvolvimento, TDD e BDD.
